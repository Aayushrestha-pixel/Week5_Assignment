...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5sumsq_sumsq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_n); /* proto */
...
#define __pyx_kp_b_iso88591_U_3aq_Rr_1 __pyx_string_tab[21]
...
/* Python wrapper */
static PyObject *__pyx_pw_5sumsq_1sumsq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_5sumsq_1sumsq = {"sumsq", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5sumsq_1sumsq, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5sumsq_1sumsq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("sumsq (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sumsq", 0) < (0)) __PYX_ERR(0, 2, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sumsq", 1, 1, 1, i); __PYX_ERR(0, 2, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("sumsq", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("sumsq.sumsq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5sumsq_sumsq(__pyx_self, __pyx_v_n);
...
static PyObject *__pyx_pf_5sumsq_sumsq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_n) {
  long __pyx_v_s;
  int __pyx_v_i;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sumsq", 0);
 ...
 *     return s
*/
  __pyx_t_1 = __Pyx_PyLong_AddObjC(__pyx_v_n, __pyx_mstate_global->__pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyIndex_AsSsize_t(__pyx_t_1); if (unlikely((__pyx_t_2 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *     return s
*/
    __pyx_v_s = (__pyx_v_s + (__pyx_v_i * __pyx_v_i));
  }
...
*/
  ...
  __pyx_t_1 = __Pyx_PyLong_From_long(__pyx_v_s); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     cdef int i
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5sumsq_1sumsq, 0, __pyx_mstate_global->__pyx_n_u_sumsq, NULL, __pyx_mstate_global->__pyx_n_u_sumsq, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_sumsq, __pyx_t_2) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{9},{20},{18},{18},{8},{1},{13},{5},{8},{10},{1},{8},{3},{12},{1},{12},{10},{5},{8},{6},{38}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (182 bytes) */
const char* const cstring = "x\332=\216\275\212\002A\020\204\021V\020\304@\337\300\027\020\304\00701\226E0.\346\306\026\006\347gw\273\347p\263\013'\234\360\036m\303{\224k\316\303\n\212*\372\203\352#\347\300\375\256\033\237@\253\326\216'g\005gz\312\205\356\206\307h]\332\3314\244,.\022[\257\016\027!\203\261\364a\354\003\270\347h\001\007\307x\203N(0\020\214\242\252\220n\331\023\240%\232\240\241K\035\320g\343_UQ&\371\277i\272\351v\366\362\367\034 \304\002|\032\237\211\277fS\263\251\333\237fQ\346\345Z\267\365PM\355\277g\323bU.e\250\353\251Y\226\375/}\225UW";
    ...
    #endif
    #else /* compression: none (215 bytes) */
const char* const bytes = "?sumsq.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__i_is_coroutineitems__main____module__n__name__pop__qualname__s__set_name__setdefaultsumsq__test__values\200\001\330\004\022\220!\340\004\010\210\005\210U\220!\2203\220a\220q\230\001\330\010\r\210R\210r\220\021\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 2};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_n, __pyx_mstate->__pyx_n_u_s, __pyx_mstate->__pyx_n_u_i};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sumsq_pyx, __pyx_mstate->__pyx_n_u_sumsq, __pyx_mstate->__pyx_kp_b_iso88591_U_3aq_Rr_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
